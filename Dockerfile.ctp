...
RUN pip3 install numpy pandas --ignore-installed
RUN pip3 install torch==1.8.0 torchvision==0.1.8 torchaudio==0.10.2 --find-links https://download.pytorch.org/whl/cu102/stable.html
...
CMD ["dotnet", "/app/server/CodeProject.AI.Server.dll"]
