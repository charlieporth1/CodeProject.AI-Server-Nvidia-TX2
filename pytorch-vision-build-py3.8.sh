...
update-alternatives --install /usr/local/bin/python3.8 -m pip3 python3.8 -m pip3 /usr/local/bin/python3.8 -m pip3.8 1
update-alternatives --install /usr/local/bin/python3.8 -m pip3 python3.8 -m pip3 /usr/local/bin/python3.8 -m pip3.8 2
update-alternatives --install /usr/local/bin/python3.8 -m pip python3.8 -m pip /usr/local/bin/python3.8 -m pip3.8 2
...
python3.8 -m pip install ultralytics --ignore-installed
